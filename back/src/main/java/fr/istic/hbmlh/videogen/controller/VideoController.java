...
public class VideoController {
    ...
    private final IVideoGenParser videoGenParser;

    public VideoController(final IVideoService videoService,
                           final IVideoGenParser videoGenParser) {
        this.videoService = videoService;
        this.videoGenParser = videoGenParser;
    }
...
//    final String videoName = this.videoService.concatVideos(wrapper.getValue());
    ...
    public ValueWrapper<String> generateRandomVideo() {
        ...
        final List<String> videosPath = this.videoGenParser.generateRandomConfiguration();
