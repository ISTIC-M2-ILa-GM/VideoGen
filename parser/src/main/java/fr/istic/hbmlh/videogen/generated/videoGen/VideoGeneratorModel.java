 ...
 * </p>
 * <ul>
 *   <li>{@link VideoGeneratorModel#getInformation <em>Information</em>}</li>
 *   <li>{@link VideoGeneratorModel#getMedias <em>Medias</em>}</li>
 * </ul>
 *
 * @see VideoGenPackage#getVideoGeneratorModel()
 * @model
 * @generated
 */
public interface VideoGeneratorModel extends EObject
{
   ...
   * @see VideoGenPackage#getVideoGeneratorModel_Information()
  ...
  /**
   * Sets the value of the '{@link VideoGeneratorModel#getInformation <em>Information</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link Media}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see VideoGenPackage#getVideoGeneratorModel_Medias()
   * @model containment="true"
   * @generated
   */
