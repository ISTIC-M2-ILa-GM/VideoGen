 ...
 * </p>
 * <ul>
 *   <li>{@link VideoDescriptionImpl#getVideoid <em>Videoid</em>}</li>
 *   <li>{@link VideoDescriptionImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link VideoDescriptionImpl#getProbability <em>Probability</em>}</li>
 *   <li>{@link VideoDescriptionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link VideoDescriptionImpl#getFilter <em>Filter</em>}</li>
 *   <li>{@link VideoDescriptionImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
